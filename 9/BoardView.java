...
/**
 * Render an ASCII-based view of the board. Rather than interacting with the model directly, the
 * {@link #draw(ReadOnlyBoardViewModel)} method takes a {@link ReadOnlyBoardViewModel}, which
 * provides just the information that this view needs.
 */
public final class BoardView {
   ...
   */
  public void draw(ReadOnlyBoardViewModel bvm)
      throws IOException {
    int columnCount = 0;
