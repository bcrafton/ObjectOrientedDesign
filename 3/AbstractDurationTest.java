...
public abstract class AbstractDurationTest {
  ...
  @Test
  public void testFormatDuplicateCharacters() {
    assertEquals("%11",
        fromDHMS(1,1,1,1).format("%%%s%s"));
  }
  ...
  @Test
  public void testFormatDoubleModulo() {
    assertEquals("%t",
                 fromDHMS(0, 4, 5, 17).format("%%t"));
  }
  ...
  @Test
  public void testFormatNoSpecificCharacter() {
    assertEquals("%zzzz",
                 fromSeconds(4191).format("%zzzz"));
  }
